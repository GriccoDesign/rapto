...
function before2selectList(form_fnc)
	{
	var oEditAddName = document.getElementById('EditAddName');
    var oEditAddRemoteName = document.getElementById('EditAddRemoteName');	
    
    //copy all back to name-field..
    if(oEditAddRemoteName.value!='')
    	{
    	oEditAddName.value += '##' + oEditAddRemoteName.value;
    	}
 	
	document.myedit.fnc.value=form_fnc	;
	}
...
function onSelect_aField(){
    ...
    else
    {
        ...
        var aNames =  oEditAddName.value.split('##');
        if(aNames.length > 1)
        	{
        	oEditAddName.value = aNames[0];
        	oEditAddRemoteName.value = aNames[1];
        	}
        else
        	{
        	oEditAddRemoteName.value = '';	
...
<form name="transfer" id="transfer" action="[{ $oViewConf->getSelfLink() }]" method="post">
    ...
    <input type="hidden" name="cl" value="PreselectMainControllerAS">
...
<input type="hidden" name="oxid" value="[{ $oxid }]">
<input type="hidden" name="editval[as_tbl_preselects__oxid]" value="[{ $oxid }]">
...
<tr>
    <td valign="top" class="edittext">
        ...
        [{block name="admin_as_Attset_List_form"}]
            <tr>
                <td class="edittext" width="100">
                [{ oxmultilang ident="FroeziMarketTranslation_ATTSETSELECTLIST_TITLE" }]
                </td>
                <td class="edittext">
                <input [{ $readonly }] type="text" class="editinput" size="25" maxlength="[{$edit->as_tbl_preselects__oxtitle->fldmax_length}]" name="editval[as_tbl_preselects__oxtitle]" value="[{$edit->as_tbl_preselects__oxtitle->value}]" style="width: 150px;">
            ...
            <tr>
                ...
                <td class="edittext">
                <input [{ $readonly }] type="text" class="editinput" size="25" maxlength="[{$edit->as_tbl_preselects__oxident->fldmax_length}]" name="editval[as_tbl_preselects__oxident]" value="[{$edit->as_tbl_preselects__oxident->value}]" style="width: 150px;">
        ...
        <tr valign="top">
            [{block name="admin_as_Attset_List_fields"}]
                <td class="edittext">
                [{ oxmultilang ident="FroeziMarketTranslation_ATTSETSELECTLIST_OPTIONS" }]
                </td>
                <td class="edittext">
                ...
                <table cellspacing="0" cellpadding="0" border="0">
                        ...
                        <tr>
                            ...
                            <td class="edittext" width="100">
                             ...
                             <td class="edittext" align="right">
                               ...
                               <input [{ $readonly }] type="text" class="edittext" id="EditAddRemoteName" name="sAddRemoteField" value="" size="15" style="width: 100px;">
                    ...
                    <tr>
                        ...
                        <td class="edittext" colspan="2" align="right">
                         <input [{ $readonly }] type="submit" class="edittext" name="save" value="[{ oxmultilang ident="GENERAL_FIELDS_ADD" }]" onClick="before2selectList('addfield');" [{ $readonly }] style="width: 100px;">
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext" width="10">&nbsp;</td>
                        <td class="edittext" colspan="2" align="right">
                         <input [{ $readonly }] type="submit" id="submit_modify" class="edittext" name="save" value="[{ oxmultilang ident="GENERAL_FIELDS_MODIFY" }]" onClick="before2selectList('changefield');" [{ $readonly }] style="width: 100px;" DISABLED>
                        </td>
                    </tr>
                    <tr>
                        <td class="edittext" width="10">&nbsp;</td>
