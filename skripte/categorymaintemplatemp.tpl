...
<tr>
    <div class="form-group has-success has-feedback" class="edittext">
      ...
      <table cellspacing="0" cellpadding="0" border="0">
        [{block name="admin_category_main_form"}]
            ...
            <tr>
                ...
                <td class="edittext">
                <a href="Javascript:DeletePic('oxthumb');" class="delete left" [{include file="Marketplace/TemplatesNatives/MarketAdmin/FormSubs/MarketAdminHelpTemplateMP.tpl" helpid=item_delete}]></a>
                [{/if}]
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <a href="Javascript:DeletePic('oxicon');" class="delete left" [{include file="Marketplace/TemplatesNatives/MarketAdmin/FormSubs/MarketAdminHelpTemplateMP.tpl" helpid=item_delete}]></a>
                [{/if}]
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <a href="Javascript:DeletePic('oxpromoicon');" class="delete left" [{include file="Marketplace/TemplatesNatives/MarketAdmin/FormSubs/MarketAdminHelpTemplateMP.tpl" helpid=item_delete}]></a>
                [{/if}]
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="edittext" colspan="2">
                <input type="text" class="editinput" size="128" maxlength="[{$edit->oxcategories__remoteparams->fldmax_length}]" name="editval[oxcategories__remoteparams]" value="[{$edit->oxcategories__remoteparams->value}]" [{$readonly}]>
                </td>
            </tr>
            <tr>
                <td class="edittext">
                ...
                <td class="edittext" colspan="2">
                <input type="text" class="editinput" size="42" maxlength="[{$edit->oxcategories__oxtemplate->fldmax_length}]" name="editval[oxcategories__oxtemplate]" value="[{$edit->oxcategories__oxtemplate->value}]" [{include file="Marketplace/TemplatesNatives/MarketAdmin/FormSubs/MarketAdminHelpTemplateMP.tpl" helpid=article_template}] [{$readonly}]>
    ...
    <!-- Anfang rechte Seite -->
    <div class="form-group has-success has-feedback" class="edittext" align="left" width="50%">
    [{ if $oxid != "-1"}]
   <!--Froezi-Adapt -->
		<!--
		<br>
			RemoteCall-Uri-Parameter
		<br>
			Marketplace Classifier
                <select name="editval[oxcategories__mpclassifier]">
				<option [{if $edit->oxcategories__mpclassifier->value == 'yes'}] selected [{/if}] value="yes">yes 
				<option [{if $edit->oxcategories__mpclassifier->value == ''}] selected [{/if}] value="">no 
			</select>
		
		<br>
			Article-Assigned AttributeSet
                <select name="editval[oxcategories__mpattributeset]">
				<option selected value="">--- 
				[{foreach from=$aAttributeSets item=attsetoption}]
					<option [{if $attsetoption.OXID ==  $edit->oxcategories__mpattributeset->value }] selected [{/if}] value="[{ $attsetoption.OXID }]">[{ $attsetoption.OXSETTITLE }]
				[{/foreach}]
		...
		<br>
		<br>
		<input [{ $readonly }] type="button" name="mpseachvals2category" value="Suchattribute" class="edittext" onclick="JavaScript:showDialog('&cl=SearchVals2CategoryControllerMP&catid=[{ $oxid }]');">
		<br>
		<br>
			SearchForm AttributeSet
                <select name="editval[oxcategories__mpattributesetsearch]">
				<option selected value="">--- 
				[{foreach from=$aAttributeSets item=attsetoption}]
					<option [{if $attsetoption.OXID ==  $edit->oxcategories__mpattributesetsearch->value }] selected [{/if}] value="[{ $attsetoption.OXID }]">[{ $attsetoption.OXSETTITLE }]
				[{/foreach}]
   ...
   <!--Froezi-Adapt -->
	...
	<br>
		   <!--Froezi-Adapt -->
		<input [{ $readonly }] type="button" name="assignArticle" value="[{ oxmultilang ident="GENERAL_ASSIGNARTICLES" }]" class="edittext" onclick="JavaScript:showDialog('&cl=mpcategory_main&aoc=1&oxid=[{ $oxid }]');" [{if $edit->oxcategories__oxpriceto->value > 0 }] disabled [{/if}]>
		   <!--Froezi-Adapt -->
